...
/**
 * A utility that can be used to measure the memory footprint of an arbitrary object graph. In a
 ...
 * follows: {@code -javaagent:path/to/object-explorer.jar}
 *
...
public class MemoryMeasurer {
   ...
   * root object and whatever object can be reached through that, excluding static fields,
